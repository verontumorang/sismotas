    ...
    jQuery(document).ready(function($) {
      ...
      $('#crudTable').on( 'draw.dt',   function () {
         crud.functionsToRunOnDataTablesDrawEvent.forEach(function(functionName) {
          ...
          <?php if($crud->getOperationSetting('lineButtonsAsDropdown')): ?>
          // Get action column
...
<?php /**PATH /home/zulfikar/projects/sismotas/vendor/backpack/crud/src/resources/views/crud/inc/datatables_logic.blade.php ENDPATH**/ ?>